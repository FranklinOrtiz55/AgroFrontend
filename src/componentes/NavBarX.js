      ...
      <div className="container-fluid">
        ...
        <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav">
            ...
            <li>
              {" "}
              <NavLink className="nav-link nav-item" to="/inventario">
                Inventario
              </NavLink>{" "}
            </li>
            <li>
              {" "}
              <NavLink className="nav-link nav-item" to="/productoGeneral">
                ProductoGeneral
              </NavLink>{" "}
            </li>
            ...
            <li>
              {" "}
              <NavLink className="nav-link nav-item" to="/ingresar">
                Ingresar
              </NavLink>{" "}
            </li>
