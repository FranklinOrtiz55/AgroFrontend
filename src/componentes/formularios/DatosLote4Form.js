    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        <TextField
          ...
          name="cantidadArbolesLote4"
          type="number"
          value={cultivo.cantidadArbolesLote4}
          onChange={handleInputChange}
          InputLabelProps={{
            shrink: true,
          }}
        ...
        <Grid item xs={12} md={6}>
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            <DatePicker
              ...
              //value={value}
              value={cultivo.fechaLote4}
              /*  onChange={(newValue) => {
              setValue(newValue);
            }} */

              onChange={(newValue) =>
                setCultivo({ ...cultivo, fechaLote4: newValue })
              }
        ...
        <TextField
          ...
          name="distanciaArbolesLote4"
          value={cultivo.distanciaArbolesLote4}
          onChange={handleInputChange}
          type="number"
        ...
        <TextField
          ...
          name="distanciaSurcosLote4"
          value={cultivo.distanciaSurcosLote4}
          onChange={handleInputChange}
          type="number"
          InputProps={{
            startAdornment: <InputAdornment position="start">metros</InputAdornment>,
        ...
        />
          ...
          <Autocomplete
            value={cultivo.valueCultivoTipoTrazoLote4}
            inputValue={cultivo.tipoTrazoLote4}
            isOptionEqualToValue={(Trazo, value) =>
            trazo.title === cultivo.tipoTrazoLote4
            }
            // required
            {...defaultProps}
            id="trazo"
            ...
            onChange={(event, newValue) =>
              setCultivo({ ...cultivo, valueCultivoTipoTrazoLote4: newValue })
            }
            onInputChange={(event, newInputValue) =>
              setCultivo({ ...cultivo, tipoTrazoLote4: newInputValue })
            }
          />
          {errores.trazo && (
