    ...
    <ThemeProvider theme={theme}>
      <Container component="main" maxWidth="xs">
        ...
        <TextField
          ...
          name="cantidadArbolesLote1"
          type="number"
          
          value={cultivo.cantidadArbolesLote1}
          onChange={handleInputChange}
          InputLabelProps={{
            shrink: true,
          }}
        ...
        <Grid item xs={12} >
          <LocalizationProvider dateAdapter={AdapterDateFns}>
            <DatePicker
              ...
              //value={value}
              value={cultivo.fechaLote1}
              /*  onChange={(newValue) => {
              setValue(newValue);
            }} */

              onChange={(newValue) =>
                setCultivo({ ...cultivo, fechaLote1: newValue })
              }
        ...
        <TextField
          ...
          name="distanciaArbolesLote1"
          value={cultivo.distanciaArbolesLote1}
          onChange={handleInputChange}
          type="number"
        ...
        <TextField
          ...
          name="distanciaSurcosLote1"
          value={cultivo.distanciaSurcosLote1}
          onChange={handleInputChange}
          type="number"
          InputProps={{
            startAdornment: <InputAdornment position="start">metros</InputAdornment>,
        ...
        />
          ...
          <Autocomplete
            value={cultivo.valueCultivoTipoTrazoLote1}
            inputValue={cultivo.tipoTrazoLote1}
            isOptionEqualToValue={(Trazo, value) =>
            trazo.title === cultivo.tipoTrazoLote1
            }
            // required
            {...defaultProps}
            id="trazo"
            ...
            onChange={(event, newValue) =>
              setCultivo({ ...cultivo, valueCultivoTipoTrazoLote1: newValue })
            }
            onInputChange={(event, newInputValue) =>
              setCultivo({ ...cultivo, tipoTrazoLote1: newInputValue })
            }
          />
          {errores.trazo && (
