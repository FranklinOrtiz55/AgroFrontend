...
import { LaborForm, InventarioForm, ProductosForm  } from "../formularios";
...
const steps = ["Tipo de Labor", "Productos Utilizados"];
...
export const LaboresScreen = () => {
  ...
  const guardar = async () => {
    ...
    const respuesta = await Axios.post("http://localhost:4000/api/productos/labores", {
      fecha: new Date(),
      productoTipo,
      valueProductoTipo,
      productoTipo2,
